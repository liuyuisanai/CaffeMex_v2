#ifndef BSCE_LOSS_LAYER_HPP_
#define BSCE_LOSS_LAYER_HPP_
...
class BSCELossLayer : public LossLayer<Dtype> {
 public:
  explicit BSCELossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "BSCELoss"; }
  virtual inline int ExactNumTopBlobs() const { return -1; }

 protected:
  /// @copydoc BSCELossLayer
