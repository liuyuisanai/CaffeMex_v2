#ifndef CAFFE_BSM_LOSS_LAYER_HPP_
#define CAFFE_BSM_LOSS_LAYER_HPP_
...
class BSMLossLayer : public LossLayer<Dtype> {
 public:
   /**
    ...
    */
  explicit BSMLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "BSMLoss"; }
...
#endif  // CAFFE_BSM_LOSS_LAYER_HPP_
