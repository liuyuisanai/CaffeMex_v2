...
#include "caffe/layers/bnhk_layer.hpp"
#include "caffe/util/math_functions.hpp"

namespace caffe {

template <typename Dtype>
void BNHKLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  frozen_ = this->layer_param_.bnhk_param().frozen();
  bn_momentum_ = this->layer_param_.bnhk_param().momentum();
  bn_eps_ = this->layer_param_.bnhk_param().eps();
...
template <typename Dtype>
void BNHKLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  num_ = bottom[0]->num();
...
template <typename Dtype>
void BNHKLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
  const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void BNHKLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_CLASS(BNHKLayer);
REGISTER_LAYER_CLASS(BNHK);
