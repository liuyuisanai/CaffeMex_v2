...
void BSMLossLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void BSMLossLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
Dtype BSMLossLayer<Dtype>::get_normalizer(
...
template <typename Dtype>
void BSMLossLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
	NOT_IMPLEMENTED;
}

template <typename Dtype>
void BSMLossLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
    const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom) {
	NOT_IMPLEMENTED;
}

#ifdef CPU_ONLY
STUB_GPU(BSMLossLayer);
#endif

INSTANTIATE_CLASS(BSMLossLayer);
REGISTER_LAYER_CLASS(BSMLoss);
